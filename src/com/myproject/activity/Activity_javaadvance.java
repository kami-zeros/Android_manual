...
public class Activity_javaadvance extends ActionBarActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_javaadvance);
		
		initView();
	}

	private void initView() {
		initActionBar(R.drawable.java_advance_logo, "Java 进阶", 1);//actionbar
		
		explistView=(ExpandableListView) this.findViewById(R.id.content_listview);
		
		//得到主标题
		List<JavaContent> contents=JavaInfoUtil.getJavaContent("java_advance", this);
		...
		for (int i = 1; i < titles.size(); i++) {
			if (i!=3) {
				...
				for (int j = 1; j < contents.size(); j++) {
					...
					switch (i) {
					case 1:
						if (contents.get(j).getShowFlag()==101 || contents.get(j).getShowFlag()==102
					...
					case 2:
						...
						break;
						/*case 3://112没数据
					if (contents.get(j).getShowFlag()==112 && contents.get(j).getImportance()!=9) {
						title=contents.get(j).getTitle2();
						childmap.put("childkey", k+"."+title);
						eachGroup.add(childmap);
						k++;
					...
					break;*/
					case 4:
						if (contents.get(j).getShowFlag()==113 && contents.get(j).getImportance()!=9) {
							title=contents.get(j).getTitle2();
							childmap.put("childkey", k+"."+title);
							eachGroup.add(childmap);
							k++;
						...
						break;
					case 5:
						if (contents.get(j).getShowFlag()==114 && contents.get(j).getImportance()!=9) {
							title=contents.get(j).getTitle2();
							childmap.put("childkey", k+"."+title);
							eachGroup.add(childmap);
							k++;
						...
						break;
					case 6:
						if (contents.get(j).getShowFlag()==115 && contents.get(j).getImportance()!=9) {
							title=contents.get(j).getTitle2();
							childmap.put("childkey", k+"."+title);
							eachGroup.add(childmap);
							k++;
						...
						break;
					case 7:
						if (contents.get(j).getShowFlag()==116 && contents.get(j).getImportance()!=9) {
							title=contents.get(j).getTitle2();
							childmap.put("childkey", k+"."+title);
							eachGroup.add(childmap);
							k++;
						...
						break;
					case 8:
						if (contents.get(j).getShowFlag()==117 && contents.get(j).getImportance()!=9) {
							title=contents.get(j).getTitle2();
							childmap.put("childkey", k+"."+title);
							eachGroup.add(childmap);
							k++;
